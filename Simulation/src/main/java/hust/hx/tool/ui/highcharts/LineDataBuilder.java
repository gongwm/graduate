package hust.hx.tool.ui.highcharts;

import java.util.ArrayList;
import java.util.List;

import hust.hx.tool.ui.highcharts.LineData.NameAndData;
import hust.hx.tool.ui.highcharts.point.LineDataPoint;
...
public class LineDataBuilder {
	...
	public static LineDataBuilder createBuilder(String title, String xName,
			String yName) {
	...
	public LineDataBuilder addSeries(String seriesName, double interval,
			double[] data) {
		double startTime = 0;
	...
	public LineDataBuilder addSeries(String seriesName, double[] time,
			double[] value) {
